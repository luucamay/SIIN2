...
public class TramosMapFragmentActivity
        extends FragmentActivity
        implements InfoWindowManager.WindowShowListener,
        GoogleMap.OnMarkerClickListener {

    public static final String LOG_TAG = TramosMapFragmentActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapInfoWindowFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                TramosMapFragmentActivity.TramosAsyncTask task = new TramosMapFragmentActivity.TramosAsyncTask();
                task.execute();
                ...
                mMap.setOnMarkerClickListener(TramosMapFragmentActivity.this);
        ...
        infoWindowManager.setWindowShowListener(TramosMapFragmentActivity.this);
